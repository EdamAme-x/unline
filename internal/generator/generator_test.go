...
func TestPatchAndVerifyAssets(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "static/js/main.js"), `const r="https://ci.line-apps.com/R4";const cfg={chrome_gw:{mobile:[{host:"line-chrome-gw.line-apps.com",protocol:"http",port:443,secure:"tls"}],wifi:[{host:"line-chrome-gw.line-apps.com",protocol:"http",port:443,secure:"tls"}]}};S({dsn:"https://abc@sentry-uit.line-apps.com/12",sampleRate:.5,tracesSampleRate:.2});`)
	mustWrite(t, filepath.Join(dir, "static/js/ltsmSandbox.js"), `const a=window.location.origin;const b=window.origin;const c= location.origin;const r="https://ci.line-apps.com/R4";const cfg={chrome_gw:{mobile:[{host:"line-chrome-gw.line-apps.com",protocol:"http",port:443,secure:"tls"}],wifi:[{host:"line-chrome-gw.line-apps.com",protocol:"http",port:443,secure:"tls"}]}};`)
